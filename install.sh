...
# RPi WiFi Fallback Hotspot - Enhanced Installer with iptables support
# Author: darkdrago74
...
log "Starting RPi WiFi Fallback Installation with Enhanced Features..."
log "=================================================================="
...
# Generated by rpi-wifi-fallback installer
*nat
...
# NAT for hotspot traffic to ethernet
-A POSTROUTING -o eth0 -j MASQUERADE
# NAT for hotspot traffic to wlan (if wlan is used for internet)
...
log "=================================================================="
log "✅ Installation completed successfully with enhanced features!"
log ""
info "🚀 New Features Added:"
info "• iptables NAT forwarding for internet sharing"
info "• Persistent firewall rules"
info "• Enhanced interface cleanup"
info "• Improved hotspot control commands"
log ""
...
log ""
info "📋 Enhanced commands:"
info "  Check status: sudo systemctl status wifi-fallback"
info "  View logs: sudo tail -f /var/log/wifi-fallback.log"
info "  Manual hotspot: hotspot on/off/status"
info "  Restart service: sudo systemctl restart wifi-fallback"
info "  Check firewall: sudo iptables -L -n"
log ""
info "🔥 Firewall & NAT configured for internet sharing through hotspot!"
